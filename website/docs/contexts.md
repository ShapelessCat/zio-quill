...
libraryDependencies ++= Seq(
  "io.getquill" %% "quill-spark" % "0.0.0+3709-5f969988-SNAPSHOT"
)
```
...
libraryDependencies ++= Seq(
  ...
  "io.getquill" %% "quill-jdbc" % "0.0.0+3709-5f969988-SNAPSHOT"
)
```
...
libraryDependencies ++= Seq(
  "mysql" % "mysql-connector-java" % "8.0.17",
  "io.getquill" %% "quill-jdbc-zio" % "0.0.0+3709-5f969988-SNAPSHOT"
)
```
...
```
libraryDependencies ++= Seq(
  "io.getquill" %% "quill-finagle-mysql" % "0.0.0+3709-5f969988-SNAPSHOT"
)
```
...
```
libraryDependencies ++= Seq(
  "io.getquill" %% "quill-finagle-postgres" % "0.0.0+3709-5f969988-SNAPSHOT"
)
```
...
```
libraryDependencies ++= Seq(
  "io.getquill" %% "quill-cassandra" % "0.0.0+3709-5f969988-SNAPSHOT"
)
```
...
```
libraryDependencies ++= Seq(
  "io.getquill" %% "quill-cassandra-zio" % "0.0.0+3709-5f969988-SNAPSHOT"
)
```
...
```
libraryDependencies ++= Seq(
  "io.getquill" %% "quill-cassandra-pekko" % "0.0.0+3709-5f969988-SNAPSHOT"
)
```
...
```
libraryDependencies ++= Seq(
  "io.getquill" %% "quill-orientdb" % "0.0.0+3709-5f969988-SNAPSHOT"
)
```
